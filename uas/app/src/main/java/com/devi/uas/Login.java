    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private void login() {
            ...
            if (loginCorrect) {
                ...
                Toast.makeText(this.getApplicationContext(), "Silahkan cek kembali username dan password anda", Toast.LENGTH_SHORT).show();
            }
        ...
        private boolean checkCredentials(String username, String password) {
            if (username.equals("men") && password.equals("men")) {
                return true;
            } else {
                return false;
            }
